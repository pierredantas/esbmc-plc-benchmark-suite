% =============================================================================
% P6 paper — draft sections: Suite Composition + Ground-Truth Methodology
% Drop into the main .tex; uses booktabs. Numbers are current as of the built suite
% (50 benchmarks / 83 variants). Swap plain terms for your \gls{} macros as needed.
% =============================================================================

% ---- place BEFORE \section{The Benchmark Suite} ----
% =============================================================================
% P6 paper — draft §Introduction (place first, before Design Principles)
% =============================================================================
...
% =============================================================================
% Place after \section{Introduction} (or before the Conclusion).
% CITE KEYS ARE PLACEHOLDERS — replace with real bib entries:
%   esbmcplc, esbmcgraphplc, esbmcplcplus  (Dantas & Cordeiro, arXiv 2606.15461 / .23870)
%   plcverif, plcverif2 (Lopez-Miguel et al., CERN)  nuxmv (Cavada et al.)  why3
%   svcomp (Beyer)  testcomp (Beyer)  plcopensuite (Ukegbu & Mehrpouyan, CPS-IoT'23)
%   plcld (Iacobelli et al., ICPS'24)  swat (Goh et al./Mathur & Tippenhauer'16)
%   llb (Govil, Agrawal & Tippenhauer'18)  ppu (Vogel-Heuser et al.)
%   kst (Wang et al., TSE'23)  matiec (de Sousa)  ebnenasir
% =============================================================================
\section{Related Work}
\label{sec:related}

\paragraph{Formal verification of IEC~61131-3.}
A growing set of tools verifies PLC logic. The ESBMC-PLC line~\cite{esbmcplc,esbmcgraphplc,esbmcplcplus}
provides an SMT-based bounded-model-checking and $k$-induction frontend for Ladder Diagram and
Structured Text; PLCverif~\cite{plcverif,plcverif2} at CERN targets Structured Text and drives
several back-end checkers; and general model checkers such as nuXmv~\cite{nuxmv} and deductive
tools such as Why3~\cite{why3} have been applied through translation. These are the tools our
...
In software verification for C, SV-COMP~\cite{svcomp} and Test-Comp~\cite{testcomp} show how a
...
effort is the PLCOpen benchmark suite of Ukegbu and Mehrpouyan~\cite{plcopensuite}, which pairs
...
dataset~\cite{plcld} and the SWaT testbed corpus~\cite{swat} (which we ingest via the
...
model of Govil et al.~\cite{llb}. The PPU pick-and-place clone-detection corpus~\cite{ppu}
...
formalisation work: the K-ST executable semantics of Wang et al.~\cite{kst}, the LD translation
rules of Ebnenasir~\cite{ebnenasir}, and the MATIEC compiler~\cite{matiec} used by several
...
% =============================================================================
% Place last, after Related Work / Evaluation.
% =============================================================================
\section{Conclusion}
...
% =============================================================================
% Place before \section{Related Work} / \section{Conclusion}.
% =============================================================================
\section{Evaluation}
\label{sec:eval}
